...
expected: Temporarily remove or comment out one EXPO*PUBLIC* var from your .env file. Restart the app. The app throws a clear error at startup identifying which env var is missing (e.g., "Missing required environment variable: EXPO_PUBLIC_REOWN_PROJECT_ID"). Restore the var after testing.
result: pass
